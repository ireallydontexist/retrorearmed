...
{
  [RevMobAds startSessionWithAppID:@"51aa739154eea672e4000004"];
  
#ifdef HAVE_DEBUG_DIAGLOG
   ios_log_init();
#endif

   self.system_directory = [NSString stringWithFormat:@"%@/.RetroRearmed", kDOCSFOLDER];
   self.systemConfigPath = [NSString stringWithFormat:@"%@/.RetroRearmed/frontend.cfg", kDOCSFOLDER];
...
{
   bool isMoreInfoTop = [viewController isKindOfClass:[RAMoreInfo class]];
